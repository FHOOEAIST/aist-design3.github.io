...
<div class="content-columns" markdown="1">
<div class="content-text" markdown="1">
...
_SEE\-KID/SEE\+\+: First prototype from 1997 \(result of a study project\)\._

</div>
</div>

<div class="fun-fact" markdown="1">
...
After the flood disaster in Upper Austria in 2002, there was a temporary substantial cutback in research funds by the province of Upper Austria, which also affected our research group and in particular the SEE\-KID project\. The project and the employees changed to Upper Austrian Research and later to RISC Software GmbH, where the product resulting from the project is currently being further developed and distributed worldwide under the name “SEE\+\+” \(for computer scientists obvious 😉\) \([www\.see\-kid\.at](http://www.see-kid.at/)\)\.
...
<div class="image-stack" markdown="1">
<div class="image-stack-item" markdown="1">

![](/assets/images/markdown/virtuellerBlindenhund.jpg)

_User interfaces of the communication and navigation module on mobile devices\._

</div>
<div class="image-stack-item" markdown="1">

![](/assets/images/markdown/einsatzVirtuellerBlindenhund.jpg)

_Use of the virtual guide dog for navigation in road traffic\._
...
![](/assets/images/markdown/projectCompass.jpg)

_Projekt Compass: A “mobile hiking map” is created from several recorded GPS tracks\._
...
![](/assets/images/markdown/ralleyProjekt.jpg)

_A former AIST employee \(and SE graduate\) installing our GPS tracker/mobile device in a rally car\. He only had a few minutes time for this in the service zone\._

</div>
</div>

<div class="image-pair" markdown="1">
<div class="image-pair-item" markdown="1">

![](/assets/images/markdown/ralleyProjektDaten.jpg)

_Recorded track of a test special stage of the January rally\. Especially speeds could be measured very precisely\._

</div>
<div class="image-pair-item" markdown="1">

![](/assets/images/markdown/ralleyProjekt_3.png)

_Detail of the recorded track: Those familiar with the area will notice that for experienced local heroes, parts of the “track edge” are also passable, which for others are pure undergrowth 😉\._
...
![](/assets/images/markdown/thinkBig.jpg)

_Automatic addition of new routes to navigation maps\._
...
![](/assets/images/markdown/ihe_collaborationnetwork.png)

_Collaboration network, generated from the IHE protocol data of a treatment process\._
...
![](/assets/images/markdown/eCarePin.png)

_e\-Care/PIN: Organisations involved and documentation systems used\._

</div>
<div class="image-stack-item" markdown="1">

![](/assets/images/markdown/eCare_communicationprocess.jpg)

_Optimized communication processes after the introduction of e\-Care\._
...
1. Use of virtual reality, augmented reality and mixed reality techniques,
2. Innovations in the radiology sector,
3. Monitoring the \(operational\) safety of systems,
4. Data Science: data acquisition, tracking, visualization, analysis, forecasting\.
...
![](/assets/images/markdown/d4k.jpg)

_Drive 4 Knowledge: Modernization of simulators\._

</div>
<div class="image-stack-item" markdown="1">

![](/assets/images/markdown/d4k_2.jpg)

_Drive 4 Knowledge: Virtual training simulator with vital data measurement\._
...
![](/assets/images/markdown/i2f.png)

_i2f Combined Game: A research project with PIE\-Lab for Rudy Games in the board game sector\._
...
![](/assets/images/markdown/wire_repo.png)

_WIRE and REPO: Two projects to improve the radiology workflow\._
