---
lang: en
page_id: pub:three-step-alignment-approach-for-fitting-a-normalized-mask-of-a-person-rotating
permalink: /publications/three-step-alignment-approach-for-fitting-a-normalized-mask-of-a-person-rotating/
date: 2021-12-31
title: Three-step Alignment Approach for Fitting a Normalized Mask of a Person
  Rotating in A-Pose or T-Pose Essential for 3D Reconstruction based on 2D
  Images and CGI Derived Reference Target Pose
reference: 'Zwettler G., Praschl C., Baumgartner D., Zucali T., Turk D., Hanreich
  M., Schuler A. (2021). Three-step Alignment Approach for Fitting a Normalized Mask
  of a Person Rotating in A-Pose or T-Pose Essential for 3D Reconstruction based on
