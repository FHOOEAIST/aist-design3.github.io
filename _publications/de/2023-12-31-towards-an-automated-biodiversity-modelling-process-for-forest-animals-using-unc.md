---
lang: de
page_id: pub:towards-an-automated-biodiversity-modelling-process-for-forest-animals-using-unc
permalink: /publications/towards-an-automated-biodiversity-modelling-process-for-forest-animals-using-unc/
date: 2023-12-31
title: Towards an Automated Biodiversity Modelling Process for Forest Animals
  using Uncrewed Aerial Vehicles
reference: Praschl C., Schedl D. „Towards an Automated Biodiversity Modelling Process
  for Forest Animals using Uncrewed Aerial Vehicles“ in Proceedings of the 11th International
  Workshop on Simulation for Energy, Sustainable Development & Environment (SESDE
  2023), 2023.
